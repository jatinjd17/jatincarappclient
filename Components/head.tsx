              ...
              <div className="2xl:hidden md:block ml-0">
                {isAuth() && (
                  <Link href="/Blog/blogs/Allblogs">
                    <div className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium cursor-pointer ml-12">
                      <p>Blogs</p>
                    </div>
                  </Link>
                )}
                ...
                {!isAuth() && (
                  <div>
                    <Link href="/Blog/user/signin">
                      <a className="text-gray-300 hover:bg-gray-700 hover:text-white px-2 py-2 rounded-md text-sm font-medium cursor-pointer">
                        SignIn
                      </a>
                    </Link>
              ...
              <div className="md:hidden lg:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <div>
                    {isAuth() && (
                      <Link href="/Blog/createblog">
                        <div className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium cursor-pointer ml-6">
                          <p>Create Blog</p>
                        </div>
                      </Link>
                    )}
