...
function BikeKeySpecSafetyFeatures({
  KeySpecification,
  SafetyFeatures,
  OnlyName,
}) {
            ...
            <div className="grid grid-cols-3 w-auto gap-1">
              ...
              <div className="bg-gray-400 rounded-md text-xl p-2">
                <span className="font-bold text-xl flex flex-row">
                  ...
                  <div className="overflow-x-auto">Power & Torque</div>
                </span>
              ...
              <div className="bg-gray-400 rounded-md text-xl p-2">
                <span className="font-bold text-xl flex flex-row">
                  ...
                  <div className="ml-2">Tyre Type</div>
                </span>{" "}
...
export default BikeKeySpecSafetyFeatures;
