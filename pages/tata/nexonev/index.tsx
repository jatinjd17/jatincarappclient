...
import { NexonEV, TigorEV } from "../../../CarPicsUrl/CarPics";
import { TNexonEV } from "../../../CarPicsUrl/Thumbnails";
...
import { ZSEVBasicInfoCard } from "../../../AllCarBasicInfo/mg";
import { KonaBasicInfoCard } from "../../../AllCarBasicInfo/hyundai";
...
function Homee({ joy }) {
  ...
  const SimilarCars = {
    car1: ZSEVBasicInfoCard,
    car2: KonaBasicInfoCard,
    car3: TigorEVBasicInfoCard,
  };
